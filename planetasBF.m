function [y_final] = planetasBF(d,v_0,passo,limite,plot1)
...
%cálculo dos 4 primeiros pontos utilizando o algoritmo RK-4. este tem ordem
%4 de consistência logo é viável para criar os primeiros pontos para o algoritmo de
%Adams-bashforth, que também tem ordem de consistência 4.
for i = 1:3
   f1(i,:) = f(h(i),y(i,:),v(i,:));
   k_1 = passo * f1(i,:);
   ...
   g1(i,:) = g(h(i),y(i,:),v(i,:),planeta1_pos(i,:),planeta2_pos(i,:),planeta3_pos(i,:));
...
for i = 4:length(h)-1
   ...
   g1_aux = g(h(i),y(i,:),v(i,:),planeta1_pos(i,:),planeta2_pos(i,:),planeta3_pos(i,:));
